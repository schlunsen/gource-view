...
const skip = new Set(['check-prod-export.mjs', 'check-real.mjs', 'check-static.mjs', 'check-browser-git.mjs', 'check-api-history.mjs', 'check-blobless.mjs', 'check-browser-export.mjs', 'check-shots.mjs']) // these need a deployed instance (BASE/REPO env)
